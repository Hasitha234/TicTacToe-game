package lk.sliit.mad.tictactoe.Storage
...
class SharedPreferenceHelper private constructor(private val context: Context) {
    ...
    val sharedPreferences: SharedPreferences = context.getSharedPreferences("TICKTACKTOE_APP_CACHE", Context.MODE_PRIVATE)
    private val editor: SharedPreferences.Editor = sharedPreferences.edit()

    companion object{

        private const val PREF_FILE = "TICKTACKTOE_APP_CACHE"
